...
ALLOWED_HOSTS = ['.localhost', '127.0.0.1', '[::1]', 'kess-finder.herokuapp.com', 'kess-finder.herokuapp.com/kess']

# Application definition

INSTALLED_APPS = [
    'kess.apps.KessConfig',
...
AUTHENTICATION_BACKENDS = ['kess.auth.CheckPasswordBackend',
